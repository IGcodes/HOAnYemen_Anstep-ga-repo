...
/Root Directory/
* code_to_pdf.py: A Python utility script that uses fpdf2 and nbformat to scan all project folders and compile the code from .py, .sh, and .ipynb files into a single, organized PDF document.
